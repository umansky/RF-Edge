...
#vfile='/home/umansky1/Collaboration/TomJenkins/RF-Edge.6dec2021/Uedge/farsol_box6hr/ion_data.h5'
...
#mp.plotvar(val, title="Ion Fpar from Vorpal", iso=False)
...
#vfile='/home/umansky1/Collaboration/TomJenkins/RF-Edge.6dec2021/Uedge/farsol_box6hr/electron_data.h5'
#Xgrid, Ygrid, Fparallel = ImportVorpal(vfile=vfile)
...
#val=Vorpal2uedge(Xgrid, Ygrid, Fparallel, com.rm, com.zm, debug=False)
#mp.plotvar(val, title="Electron Fpar from Vorpal", iso=False)
