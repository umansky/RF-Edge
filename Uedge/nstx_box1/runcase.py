...
grd.radm=-4.e-2    #-minimum "radial" position
...
grd.btfix = 0.5              #constant total B-field
...
bbb.ncore=3e19    #-density on core boundary
bbb.iflcore=1     #if=1, specify core power
bbb.tcoree=25.0   #-used if iflcore=0
bbb.tcorei=25.0   #-used if iflcore=0
bbb.pcoree = 1e6  #-used if iflcore=1        
bbb.pcorei = 1e6  #-used if iflcore=1
