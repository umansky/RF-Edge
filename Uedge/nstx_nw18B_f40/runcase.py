...
com.isgrdsym=1 #-make the grid symmetric in z

grd.radx= 30e-2    #-outer "radial" wall
grd.rad0=0.0       #-location of 'radial' separ'x for cylinder or slab
grd.radm=-5.e-2    #-minimum "radial" position

grd.za0 = 0.    #-poloidal symmetry plane location
grd.zax=1.0     #-poloidal location of divertor plate   
grd.zaxpt=0.9   #-poloidal location of x-point
#grd.alfyt=-1.0  #radial nonuniformity factor; < 0 => expanding
grd.alfyt=-0.930 #radial nonuniformity factor; < 0 => expanding
...
grd.btfix = 1.0             #constant total B-field
grd.bpolfix = 0.5           #constant poloidal B-field
...
bbb.recycp=0.90  #-recycling coef at plates if ndatlb,rb=0
